...
contract PublicSaleTimeLock {
    address owner;
    bool private _isPublicSaleFilled = false;
    ...
    uint16[2] PublicSalePayOuts = [0, 100];
    ...
    function closePublicSaleList() public onlyOwner {
        _isPublicSaleFilled = true;
