                    ...
                    <Block align={'center'}>
                        <PredictionRange>
                            ...
                            <DesktopPrediction>
                                ...
                                <RowModal>
                                    <small>
                                        ${bitcoinValue - range} - ${bitcoinValue + range}
                                    </small>
                                </RowModal>
                            </DesktopPrediction>
                        ...
                        <ConfirmPredict background={TotemsData[totem].color}>
                            ...
                            <InputWrapperBottom>
                                <input
                                    type="number"
                                    value={betValue}
                                    onChange={e => changeInputBetValue(+e.target.value)}
                                />
                            </InputWrapperBottom>
                            <PercentBlock>
...
function calculateRange(betValue: number): number{
    if (betValue < 27501) {
    ...
    if (betValue > 75000) {
        return Math.round((27500 / 500 * 10) + (30000 / 500 * 7) + (17500 / 500 * 3.75) + ((betValue - 75000) / 500 * 2))
    }
    return 500;
}
